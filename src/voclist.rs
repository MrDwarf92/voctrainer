...
pub fn new(id:i64, lang_1:String, lang_2:String, friendly_1:String, friendly_2:String) -> Vocab {
    return Vocab {
        id,
        lang_1,
        lang_2,
...
{
    if mode==1 {
        return &self.friendly_1;
    }
    else {
        return &self.friendly_2;
    }
}
...
pub fn get_friendly_1(&self)->&String {
    return &self.friendly_1;
}

pub fn get_friendly_2(&self)->&String {
    return &self.friendly_2;
}
